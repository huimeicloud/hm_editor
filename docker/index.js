...
app.post('/emr-editor/dynamicFooter', function (req, res) {
...
app.post('/emr-editor/dynamicHeader', function (req, res) {
...
app.post('/emr-editor/dynamicHtml', function (req, res) {
...
app.get('/emr-editor/dynamicHeaderFooter', function (req, res) {
...
app.post('/emr-editor/base64', function (req, res) {
	var str = Buffer.from(JSON.stringify(req.body.param)).toString('base64');
	res.send(str);
});

app.listen(39090,'0.0.0.0',function(){
	console.log('ready...');
});
