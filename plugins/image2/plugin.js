...
( function() {
	...
	CKEDITOR.plugins.add( 'image2', {
		...
		init: function( editor ) {
			...
			// modify by liwenjuan 2018/11/26
			...
			CKEDITOR.dialog.add( 'image2', this.path + 'dialogs/local-image.js' );
		},
		...
		return {
			...
			data: function() {
				...
				this.parts.image.setAttributes( {
					...
					src: $(this)[0].parts.image.$.src,
					// This internal is required by the editor.
					// 'data-cke-saved-src': $(this)[0].parts.image.$.src,
					alt: this.data.alt
				} );
				this.parts.image.removeAttribute('data-cke-saved-src');
				this.parts.image.removeAttribute('data-cke-widget-data');
